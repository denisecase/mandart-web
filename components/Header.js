...
import { saveMandArtFile, saveCanvasAsPNG, exportGridToCSV } from "../utils/FileUtils.js";
import { loadMandArtCatalog } from "../utils/CatalogUtils.js";
import { readFromMandart, loadMandArt, getActiveFilename } from "./MandArtLoader.js";
...
export function setupHeader() {
    ...
    if (window.wasmModule) {
        ...
        console.warn("⚠️ WASM not yet loaded, delaying MandArt dropdown population.");
    }
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    if (!jsonData.hues || !Array.isArray(jsonData.hues)) {
                        throw new Error("❌ Invalid MandArt file: 'hues' array missing or not an array.");
                    }
