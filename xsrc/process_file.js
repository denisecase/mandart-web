...
export async function processFile(fileObj) {
    try {
        ...
        if (!activeWasm.api_get_inputs_from_picdef_string) {
            console.error("❌ Required WASM function 'api_get_inputs_from_picdef_string' not found");
        ...
        const [shapeInputs, colorInputs] = activeWasm.api_get_inputs_from_picdef_string(
